...
namespace Spatie\Multitenancy\Support;

use Illuminate\Support\Facades\File;

class MigrationPathHelper
{
    /**
     * Obtiene el path base para migraciones según el tipo de entorno
     *
     * @param  string  $type  Tipo de migración ('landlord' o 'tenant')
     * @return string Path relativo
     */
    public static function getBasePath(string $type): string
    {
        return config("multitenancy.{$type}_migrations_path", "database/migrations/{$type}");
    }
